exports.id=53,exports.ids=[53],exports.modules={9725:(e,t,i)=>{i.r(t),i.d(t,{AIProviderService:()=>AIProviderService,getMaxCharacters:()=>W,getOrPromptApiKey:()=>B,showDiffTruncationWarning:()=>j});var n=i(1398),o=i(1242),a=i(3180),r=i(4180),s=i(8381),d=i(5546),l=i(5395),c=i(7279);async function u(e,t){let i;let o=await (await e.ai)?.getModels()??[],a=[];for(let e of o){if(e.hidden)continue;i!==e.provider.id&&(i=e.provider.id,a.push({label:e.provider.name,kind:n.QuickPickItemKind.Separator}));let o=e.provider.id===t?.provider&&e.id===t?.model;a.push({label:e.name,iconPath:new n.ThemeIcon(o?"check":"blank"),model:e,picked:o})}let r=n.window.createQuickPick();r.ignoreFocusOut=(0,c.dW)();let s=[],u={iconPath:new n.ThemeIcon("clear-all"),tooltip:"Reset AI Keys..."};try{return await new Promise(e=>{s.push(r.onDidHide(()=>e(void 0)),r.onDidAccept(()=>{0!==r.activeItems.length&&e(r.activeItems[0])}),r.onDidTriggerButton(e=>{e===u&&(0,l.RS)(d.T.ResetAIKey)})),r.title="Choose AI Model",r.placeholder="Select an AI model to use for experimental AI features",r.matchOnDescription=!0,r.matchOnDetail=!0,r.buttons=[u],r.items=a,r.show()})}finally{r.dispose(),s.forEach(e=>void e.dispose())}}var m=i(2414),p=i(2469),h=i(216),g=i(4866),f=i(9153);let y="You are an advanced AI programming assistant",v=`You are tasked with summarizing code changes into a concise but meaningful commit message. You will be provided with a code diff and optional additional context. Your goal is to analyze the changes and create a clear, informative commit message that accurately represents the modifications made to the code.
