...
`,_n=class extends lit_element_r{constructor(){super(),((e,t,n)=>{if(t.has(e))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(e):t.set(e,n)})(this,xn,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach((([e,t])=>{this.constructor.define(e,t)}))}emit(e,t){const n=new CustomEvent(e,Qi({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){const o=customElements.get(e);if(!o){try{customElements.define(e,t,n)}catch(o){customElements.define(e,class extends t{},n)}return}let r=" (unknown version)",a=r;"version"in t&&t.version&&(r=" v"+t.version),"version"in o&&o.version&&(a=" v"+o.version)}attributeChangedCallback(e,t,n){var o,r,a;en(o=this,r=xn,"read from private field"),(a?a.call(o):r.get(o))||(this.constructor.elementProperties.forEach(((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])})),((e,t,n,o)=>{en(e,t,"write to private field"),o?o.call(e,n):t.set(e,n)})(this,xn,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach(((t,n)=>{e.has(n)&&null==this[n]&&(this[n]=t)}))}};xn=new WeakMap,_n.version="2.18.0",_n.dependencies={},Ji([xi()],_n.prototype,"dir",2),Ji([xi()],_n.prototype,"lang",2);const $n=Math.min,An=Math.max,Cn=Math.round,Sn=Math.floor,En=e=>({x:e,y:e}),Pn={left:"right",right:"left",bottom:"top",top:"bottom"},Rn={start:"end",end:"start"};function Tn(e,t,n){return An(e,$n(t,n))}function On(e,t){return"function"==typeof e?e(t):e}function Mn(e){return e.split("-")[0]}function Ln(e){return e.split("-")[1]}function Dn(e){return"x"===e?"y":"x"}function zn(e){return"y"===e?"height":"width"}function In(e){return["top","bottom"].includes(Mn(e))?"y":"x"}function Bn(e){return Dn(In(e))}function jn(e){return e.replace(/start|end/g,(e=>Rn[e]))}function Un(e){return e.replace(/left|right|bottom|top/g,(e=>Pn[e]))}function Nn(e){return"number"!=typeof e?function(e){return{top:0,right:0,bottom:0,left:0,...e}}(e):{top:e,right:e,bottom:e,left:e}}function Hn(e){const{x:t,y:n,width:o,height:r}=e;return{width:o,height:r,top:n,left:t,right:t+o,bottom:n+r,x:t,y:n}}function Fn(e,t,n){let{reference:o,floating:r}=e;const a=In(t),l=Bn(t),c=zn(l),d=Mn(t),h="y"===a,p=o.x+o.width/2-r.width/2,u=o.y+o.height/2-r.height/2,f=o[c]/2-r[c]/2;let g;switch(d){case"top":g={x:p,y:o.y-r.height};break;case"bottom":g={x:p,y:o.y+o.height};break;case"right":g={x:o.x+o.width,y:u};break;case"left":g={x:o.x-r.width,y:u};break;default:g={x:o.x,y:o.y}}switch(Ln(t)){case"start":g[l]-=f*(n&&h?-1:1);break;case"end":g[l]+=f*(n&&h?-1:1)}return g}async function qn(e,t){var n;void 0===t&&(t={});const{x:o,y:r,platform:a,rects:l,elements:c,strategy:d}=e,{boundary:h="clippingAncestors",rootBoundary:p="viewport",elementContext:u="floating",altBoundary:f=!1,padding:g=0}=On(t,e),m=Nn(g),b=c[f?"floating"===u?"reference":"floating":u],v=Hn(await a.getClippingRect({element:null==(n=await(null==a.isElement?void 0:a.isElement(b)))||n?b:b.contextElement||await(null==a.getDocumentElement?void 0:a.getDocumentElement(c.floating)),boundary:h,rootBoundary:p,strategy:d})),y="floating"===u?{x:o,y:r,width:l.floating.width,height:l.floating.height}:l.reference,w=await(null==a.getOffsetParent?void 0:a.getOffsetParent(c.floating)),x=await(null==a.isElement?void 0:a.isElement(w))&&await(null==a.getScale?void 0:a.getScale(w))||{x:1,y:1},k=Hn(a.convertOffsetParentRelativeRectToViewportRelativeRect?await a.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:y,offsetParent:w,strategy:d}):y);return{top:(v.top-k.top+m.top)/x.y,bottom:(k.bottom-v.bottom+m.bottom)/x.y,left:(v.left-k.left+m.left)/x.x,right:(k.right-v.right+m.right)/x.x}}function Vn(){return"undefined"!=typeof window}function Wn(e){return Zn(e)?(e.nodeName||"").toLowerCase():"#document"}function Gn(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function Kn(e){var t;return null==(t=(Zn(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function Zn(e){return!!Vn()&&(e instanceof Node||e instanceof Gn(e).Node)}function Yn(e){return!!Vn()&&(e instanceof Element||e instanceof Gn(e).Element)}function Qn(e){return!!Vn()&&(e instanceof HTMLElement||e instanceof Gn(e).HTMLElement)}function Xn(e){return!(!Vn()||"undefined"==typeof ShadowRoot)&&(e instanceof ShadowRoot||e instanceof Gn(e).ShadowRoot)}function Jn(e){const{overflow:t,overflowX:n,overflowY:o,display:r}=ro(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+n)&&!["inline","contents"].includes(r)}function eo(e){return["table","td","th"].includes(Wn(e))}function to(e){return[":popover-open",":modal"].some((t=>{try{return e.matches(t)}catch(e){return!1}}))}function io(e){const t=no(),n=Yn(e)?ro(e):e;return"none"!==n.transform||"none"!==n.perspective||!!n.containerType&&"normal"!==n.containerType||!t&&!!n.backdropFilter&&"none"!==n.backdropFilter||!t&&!!n.filter&&"none"!==n.filter||["transform","perspective","filter"].some((e=>(n.willChange||"").includes(e)))||["paint","layout","strict","content"].some((e=>(n.contain||"").includes(e)))}function no(){return!("undefined"==typeof CSS||!CSS.supports)&&CSS.supports("-webkit-backdrop-filter","none")}function oo(e){return["html","body","#document"].includes(Wn(e))}function ro(e){return Gn(e).getComputedStyle(e)}function so(e){return Yn(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ao(e){if("html"===Wn(e))return e;const t=e.assignedSlot||e.parentNode||Xn(e)&&e.host||Kn(e);return Xn(t)?t.host:t}function lo(e){const t=ao(e);return oo(t)?e.ownerDocument?e.ownerDocument.body:e.body:Qn(t)&&Jn(t)?t:lo(t)}function co(e,t,n){var o;void 0===t&&(t=[]),void 0===n&&(n=!0);const r=lo(e),a=r===(null==(o=e.ownerDocument)?void 0:o.body),l=Gn(r);if(a){const e=ho(l);return t.concat(l,l.visualViewport||[],Jn(r)?r:[],e&&n?co(e):[])}return t.concat(r,co(r,[],n))}function ho(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function uo(e){const t=ro(e);let n=parseFloat(t.width)||0,o=parseFloat(t.height)||0;const r=Qn(e),a=r?e.offsetWidth:n,l=r?e.offsetHeight:o,c=Cn(n)!==a||Cn(o)!==l;return c&&(n=a,o=l),{width:n,height:o,$:c}}function fo(e){return Yn(e)?e:e.contextElement}function go(e){const t=fo(e);if(!Qn(t))return En(1);const n=t.getBoundingClientRect(),{width:o,height:r,$:a}=uo(t);let l=(a?Cn(n.width):n.width)/o,c=(a?Cn(n.height):n.height)/r;return l&&Number.isFinite(l)||(l=1),c&&Number.isFinite(c)||(c=1),{x:l,y:c}}const mo=En(0);function wo(e){const t=Gn(e);return no()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:mo}function xo(e,t,n,o){void 0===t&&(t=!1),void 0===n&&(n=!1);const r=e.getBoundingClientRect(),a=fo(e);let l=En(1);t&&(o?Yn(o)&&(l=go(o)):l=go(e));const c=function(e,t,n){return void 0===t&&(t=!1),!(!n||t&&n!==Gn(e))&&t}(a,n,o)?wo(a):En(0);let d=(r.left+c.x)/l.x,h=(r.top+c.y)/l.y,p=r.width/l.x,u=r.height/l.y;if(a){const e=Gn(a),t=o&&Yn(o)?Gn(o):o;let n=e,r=ho(n);for(;r&&o&&t!==n;){const e=go(r),t=r.getBoundingClientRect(),o=ro(r),a=t.left+(r.clientLeft+parseFloat(o.paddingLeft))*e.x,l=t.top+(r.clientTop+parseFloat(o.paddingTop))*e.y;d*=e.x,h*=e.y,p*=e.x,u*=e.y,d+=a,h+=l,n=Gn(r),r=ho(n)}}return Hn({width:p,height:u,x:d,y:h})}function ko(e,t){const n=so(e).scrollLeft;return t?t.left+n:xo(Kn(e)).left+n}function _o(e,t,n){void 0===n&&(n=!1);const o=e.getBoundingClientRect();return{x:o.left+t.scrollLeft-(n?0:ko(e,o)),y:o.top+t.scrollTop}}function Ao(e,t,n){let o;if("viewport"===t)o=function(e,t){const n=Gn(e),o=Kn(e),r=n.visualViewport;let a=o.clientWidth,l=o.clientHeight,c=0,d=0;if(r){a=r.width,l=r.height;const e=no();(!e||e&&"fixed"===t)&&(c=r.offsetLeft,d=r.offsetTop)}return{width:a,height:l,x:c,y:d}}(e,n);else if("document"===t)o=function(e){const t=Kn(e),n=so(e),o=e.ownerDocument.body,r=An(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),a=An(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight);let l=-n.scrollLeft+ko(e);const c=-n.scrollTop;return"rtl"===ro(o).direction&&(l+=An(t.clientWidth,o.clientWidth)-r),{width:r,height:a,x:l,y:c}}(Kn(e));else if(Yn(t))o=function(e,t){const n=xo(e,!0,"fixed"===t),o=n.top+e.clientTop,r=n.left+e.clientLeft,a=Qn(e)?go(e):En(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:r*a.x,y:o*a.y}}(t,n);else{const n=wo(e);o={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Hn(o)}function Co(e,t){const n=ao(e);return!(n===t||!Yn(n)||oo(n))&&("fixed"===ro(n).position||Co(n,t))}function So(e,t,n){const o=Qn(t),r=Kn(t),a="fixed"===n,l=xo(e,!0,a,t);let c={scrollLeft:0,scrollTop:0};const d=En(0);if(o||!o&&!a)if(("body"!==Wn(t)||Jn(r))&&(c=so(t)),o){const e=xo(t,!0,a,t);d.x=e.x+t.clientLeft,d.y=e.y+t.clientTop}else r&&(d.x=ko(r));const h=!r||o||a?En(0):_o(r,c);return{x:l.left+c.scrollLeft-d.x-h.x,y:l.top+c.scrollTop-d.y-h.y,width:l.width,height:l.height}}function Eo(e){return"static"===ro(e).position}function Po(e,t){if(!Qn(e)||"fixed"===ro(e).position)return null;if(t)return t(e);let n=e.offsetParent;return Kn(e)===n&&(n=n.ownerDocument.body),n}function To(e,t){const n=Gn(e);if(to(e))return n;if(!Qn(e)){let t=ao(e);for(;t&&!oo(t);){if(Yn(t)&&!Eo(t))return t;t=ao(t)}return n}let o=Po(e,t);for(;o&&eo(o)&&Eo(o);)o=Po(o,t);return o&&oo(o)&&Eo(o)&&!io(o)?n:o||function(e){let t=ao(e);for(;Qn(t)&&!oo(t);){if(io(t))return t;if(to(t))return null;t=ao(t)}return null}(e)||n}const Oo={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:n,offsetParent:o,strategy:r}=e;const a="fixed"===r,l=Kn(o),c=!!t&&to(t.floating);if(o===l||c&&a)return n;let d={scrollLeft:0,scrollTop:0},h=En(1);const p=En(0),u=Qn(o);if((u||!u&&!a)&&(("body"!==Wn(o)||Jn(l))&&(d=so(o)),Qn(o))){const e=xo(o);h=go(o),p.x=e.x+o.clientLeft,p.y=e.y+o.clientTop}const f=!l||u||a?En(0):_o(l,d,!0);return{width:n.width*h.x,height:n.height*h.y,x:n.x*h.x-d.scrollLeft*h.x+p.x+f.x,y:n.y*h.y-d.scrollTop*h.y+p.y+f.y}},getDocumentElement:Kn,getClippingRect:function(e){let{element:t,boundary:n,rootBoundary:o,strategy:r}=e;const a=[..."clippingAncestors"===n?to(t)?[]:function(e,t){const n=t.get(e);if(n)return n;let o=co(e,[],!1).filter((e=>Yn(e)&&"body"!==Wn(e))),r=null;const a="fixed"===ro(e).position;let l=a?ao(e):e;for(;Yn(l)&&!oo(l);){const t=ro(l),n=io(l);n||"fixed"!==t.position||(r=null),(a?!n&&!r:!n&&"static"===t.position&&r&&["absolute","fixed"].includes(r.position)||Jn(l)&&!n&&Co(e,l))?o=o.filter((e=>e!==l)):r=t,l=ao(l)}return t.set(e,o),o}(t,this._c):[].concat(n),o],l=a[0],c=a.reduce(((e,n)=>{const o=Ao(t,n,r);return e.top=An(o.top,e.top),e.right=$n(o.right,e.right),e.bottom=$n(o.bottom,e.bottom),e.left=An(o.left,e.left),e}),Ao(t,l,r));return{width:c.right-c.left,height:c.bottom-c.top,x:c.left,y:c.top}},getOffsetParent:To,getElementRects:async function(e){const t=this.getOffsetParent||To,n=this.getDimensions,o=await n(e.floating);return{reference:So(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){const{width:t,height:n}=uo(e);return{width:t,height:n}},getScale:go,isElement:Yn,isRTL:function(e){return"rtl"===ro(e).direction}};function Lo(e,t,n,o){void 0===o&&(o={});const{ancestorScroll:r=!0,ancestorResize:a=!0,elementResize:l="function"==typeof ResizeObserver,layoutShift:c="function"==typeof IntersectionObserver,animationFrame:d=!1}=o,h=fo(e),p=r||a?[...h?co(h):[],...co(t)]:[];p.forEach((e=>{r&&e.addEventListener("scroll",n,{passive:!0}),a&&e.addEventListener("resize",n)}));const u=h&&c?function(e,t){let n,o=null;const r=Kn(e);function a(){var e;clearTimeout(n),null==(e=o)||e.disconnect(),o=null}return function l(c,d){void 0===c&&(c=!1),void 0===d&&(d=1),a();const{left:h,top:p,width:u,height:f}=e.getBoundingClientRect();if(c||t(),!u||!f)return;const g={rootMargin:-Sn(p)+"px "+-Sn(r.clientWidth-(h+u))+"px "+-Sn(r.clientHeight-(p+f))+"px "+-Sn(h)+"px",threshold:An(0,$n(1,d))||1};let m=!0;function b(e){const t=e[0].intersectionRatio;if(t!==d){if(!m)return l();t?l(!1,t):n=setTimeout((()=>{l(!1,1e-7)}),1e3)}m=!1}try{o=new IntersectionObserver(b,{...g,root:r.ownerDocument})}catch(e){o=new IntersectionObserver(b,g)}o.observe(e)}(!0),a}(h,n):null;let f,g=-1,m=null;l&&(m=new ResizeObserver((e=>{let[o]=e;o&&o.target===h&&m&&(m.unobserve(t),cancelAnimationFrame(g),g=requestAnimationFrame((()=>{var e;null==(e=m)||e.observe(t)}))),n()})),h&&!d&&m.observe(h),m.observe(t));let b=d?xo(e):null;return d&&function t(){const o=xo(e);!b||o.x===b.x&&o.y===b.y&&o.width===b.width&&o.height===b.height||n();b=o,f=requestAnimationFrame(t)}(),n(),()=>{var e;p.forEach((e=>{r&&e.removeEventListener("scroll",n),a&&e.removeEventListener("resize",n)})),null==u||u(),null==(e=m)||e.disconnect(),m=null,d&&cancelAnimationFrame(f)}}const zo=function(e){return void 0===e&&(e=0),{name:"offset",options:e,async fn(t){var n,o;const{x:r,y:a,placement:l,middlewareData:c}=t,d=await async function(e,t){const{placement:n,platform:o,elements:r}=e,a=await(null==o.isRTL?void 0:o.isRTL(r.floating)),l=Mn(n),c=Ln(n),d="y"===In(n),h=["left","top"].includes(l)?-1:1,p=a&&d?-1:1,u=On(t,e);let{mainAxis:f,crossAxis:g,alignmentAxis:m}="number"==typeof u?{mainAxis:u,crossAxis:0,alignmentAxis:null}:{mainAxis:u.mainAxis||0,crossAxis:u.crossAxis||0,alignmentAxis:u.alignmentAxis};return c&&"number"==typeof m&&(g="end"===c?-1*m:m),d?{x:g*p,y:f*h}:{x:f*h,y:g*p}}(t,e);return l===(null==(n=c.offset)?void 0:n.placement)&&null!=(o=c.arrow)&&o.alignmentOffset?{}:{x:r+d.x,y:a+d.y,data:{...d,placement:l}}}}},Io=function(e){return void 0===e&&(e={}),{name:"shift",options:e,async fn(t){const{x:n,y:o,placement:r}=t,{mainAxis:a=!0,crossAxis:l=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...d}=On(e,t),h={x:n,y:o},p=await qn(t,d),u=In(Mn(r)),f=Dn(u);let g=h[f],m=h[u];if(a){const e="y"===f?"bottom":"right";g=Tn(g+p["y"===f?"top":"left"],g,g-p[e])}if(l){const e="y"===u?"bottom":"right";m=Tn(m+p["y"===u?"top":"left"],m,m-p[e])}const b=c.fn({...t,[f]:g,[u]:m});return{...b,data:{x:b.x-n,y:b.y-o,enabled:{[f]:a,[u]:l}}}}}},jo=function(e){return void 0===e&&(e={}),{name:"flip",options:e,async fn(t){var n,o;const{placement:r,middlewareData:a,rects:l,initialPlacement:c,platform:d,elements:h}=t,{mainAxis:p=!0,crossAxis:u=!0,fallbackPlacements:f,fallbackStrategy:g="bestFit",fallbackAxisSideDirection:m="none",flipAlignment:b=!0,...v}=On(e,t);if(null!=(n=a.arrow)&&n.alignmentOffset)return{};const y=Mn(r),w=In(c),x=Mn(c)===c,k=await(null==d.isRTL?void 0:d.isRTL(h.floating)),_=f||(x||!b?[Un(c)]:function(e){const t=Un(e);return[jn(e),t,jn(t)]}(c)),A="none"!==m;!f&&A&&_.push(...function(e,t,n,o){const r=Ln(e);let a=function(e,t,n){const o=["left","right"],r=["right","left"],a=["top","bottom"],l=["bottom","top"];switch(e){case"top":case"bottom":return n?t?r:o:t?o:r;case"left":case"right":return t?a:l;default:return[]}}(Mn(e),"start"===n,o);return r&&(a=a.map((e=>e+"-"+r)),t&&(a=a.concat(a.map(jn)))),a}(c,b,m,k));const C=[c,..._],S=await qn(t,v),E=[];let P=(null==(o=a.flip)?void 0:o.overflows)||[];if(p&&E.push(S[y]),u){const e=function(e,t,n){void 0===n&&(n=!1);const o=Ln(e),r=Bn(e),a=zn(r);let l="x"===r?o===(n?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[a]>t.floating[a]&&(l=Un(l)),[l,Un(l)]}(r,l,k);E.push(S[e[0]],S[e[1]])}if(P=[...P,{placement:r,overflows:E}],!E.every((e=>e<=0))){var R,T;const e=((null==(R=a.flip)?void 0:R.index)||0)+1,t=C[e];if(t)return{data:{index:e,overflows:P},reset:{placement:t}};let n=null==(T=P.filter((e=>e.overflows[0]<=0)).sort(((e,t)=>e.overflows[1]-t.overflows[1]))[0])?void 0:T.placement;if(!n)switch(g){case"bestFit":{var O;const e=null==(O=P.filter((e=>{if(A){const t=In(e.placement);return t===w||"y"===t}return!0})).map((e=>[e.placement,e.overflows.filter((e=>e>0)).reduce(((e,t)=>e+t),0)])).sort(((e,t)=>e[1]-t[1]))[0])?void 0:O[0];e&&(n=e);break}case"initialPlacement":n=c}if(r!==n)return{reset:{placement:n}}}return{}}}},Uo=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var n,o;const{placement:r,rects:a,platform:l,elements:c}=t,{apply:d=()=>{},...h}=On(e,t),p=await qn(t,h),u=Mn(r),f=Ln(r),g="y"===In(r),{width:m,height:b}=a.floating;let v,y;"top"===u||"bottom"===u?(v=u,y=f===(await(null==l.isRTL?void 0:l.isRTL(c.floating))?"start":"end")?"left":"right"):(y=u,v="end"===f?"top":"bottom");const w=b-p.top-p.bottom,x=m-p.left-p.right,k=$n(b-p[v],w),_=$n(m-p[y],x),A=!t.middlewareData.shift;let C=k,S=_;if(null!=(n=t.middlewareData.shift)&&n.enabled.x&&(S=x),null!=(o=t.middlewareData.shift)&&o.enabled.y&&(C=w),A&&!f){const e=An(p.left,0),t=An(p.right,0),n=An(p.top,0),o=An(p.bottom,0);g?S=m-2*(0!==e||0!==t?e+t:An(p.left,p.right)):C=b-2*(0!==n||0!==o?n+o:An(p.top,p.bottom))}await d({...t,availableWidth:S,availableHeight:C});const E=await l.getDimensions(c.floating);return m!==E.width||b!==E.height?{reset:{rects:!0}}:{}}}},No=e=>({name:"arrow",options:e,async fn(t){const{x:n,y:o,placement:r,rects:a,platform:l,elements:c,middlewareData:d}=t,{element:h,padding:p=0}=On(e,t)||{};if(null==h)return{};const u=Nn(p),f={x:n,y:o},g=Bn(r),m=zn(g),b=await l.getDimensions(h),v="y"===g,y=v?"top":"left",w=v?"bottom":"right",x=v?"clientHeight":"clientWidth",k=a.reference[m]+a.reference[g]-f[g]-a.floating[m],_=f[g]-a.reference[g],A=await(null==l.getOffsetParent?void 0:l.getOffsetParent(h));let C=A?A[x]:0;C&&await(null==l.isElement?void 0:l.isElement(A))||(C=c.floating[x]||a.floating[m]);const S=k/2-_/2,E=C/2-b[m]/2-1,P=$n(u[y],E),R=$n(u[w],E),T=P,O=C-b[m]-R,M=C/2-b[m]/2+S,L=Tn(T,M,O),D=!d.arrow&&null!=Ln(r)&&M!==L&&a.reference[m]/2-(M<T?P:R)-b[m]/2<0,I=D?M<T?M-T:M-O:0;return{[g]:f[g]+I,data:{[g]:L,centerOffset:M-L-I,...D&&{alignmentOffset:I}},reset:D}}}),Fo=(e,t,n)=>{const o=new Map,r={platform:Oo,...n},a={...r.platform,_c:o};return(async(e,t,n)=>{const{placement:o="bottom",strategy:r="absolute",middleware:a=[],platform:l}=n,c=a.filter(Boolean),d=await(null==l.isRTL?void 0:l.isRTL(t));let h=await l.getElementRects({reference:e,floating:t,strategy:r}),{x:p,y:u}=Fn(h,o,d),f=o,g={},m=0;for(let n=0;n<c.length;n++){const{name:a,fn:b}=c[n],{x:v,y,data:w,reset:x}=await b({x:p,y:u,initialPlacement:o,placement:f,strategy:r,middlewareData:g,rects:h,platform:l,elements:{reference:e,floating:t}});p=null!=v?v:p,u=null!=y?y:u,g={...g,[a]:{...g[a],...w}},x&&m<=50&&(m++,"object"==typeof x&&(x.placement&&(f=x.placement),x.rects&&(h=!0===x.rects?await l.getElementRects({reference:e,floating:t,strategy:r}):x.rects),({x:p,y:u}=Fn(h,f,d))),n=-1)}return{x:p,y:u,placement:f,strategy:r,middlewareData:g}})(e,t,{...r,platform:a})},qo=Ti(class extends directive_i{constructor(e){if(super(e),e.type!==Pi||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const n=e.element.classList;for(const e of this.st)e in t||(n.remove(e),this.st.delete(e));for(const e in t){const o=!!t[e];o===this.st.has(e)||this.nt?.has(e)||(o?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return li}});function Vo(e){return Go(e)}function Wo(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Go(e){for(let t=e;t;t=Wo(t))if(t instanceof Element&&"none"===getComputedStyle(t).display)return null;for(let t=Wo(e);t;t=Wo(t)){if(!(t instanceof Element))continue;const e=getComputedStyle(t);if("contents"!==e.display){if("static"!==e.position||"none"!==e.filter)return t;if("BODY"===t.tagName)return t}}return null}var Ko=class extends _n{constructor(){super(...arguments),this.localize=new wn(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){const e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect();let n=0,o=0,r=0,a=0,l=0,c=0,d=0,h=0;this.placement.includes("top")||this.placement.includes("bottom")?e.top<t.top?(n=e.left,o=e.bottom,r=e.right,a=e.bottom,l=t.left,c=t.top,d=t.right,h=t.top):(n=t.left,o=t.bottom,r=t.right,a=t.bottom,l=e.left,c=e.top,d=e.right,h=e.top):e.left<t.left?(n=e.right,o=e.top,r=t.left,a=t.top,l=e.right,c=e.bottom,d=t.left,h=t.bottom):(n=t.right,o=t.top,r=e.left,a=e.top,l=t.right,c=t.bottom,d=e.left,h=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${n}px`),this.style.setProperty("--hover-bridge-top-left-y",`${o}px`),this.style.setProperty("--hover-bridge-top-right-x",`${r}px`),this.style.setProperty("--hover-bridge-top-right-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){const e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||function(e){return null!==e&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e instanceof Element)}(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&(this.cleanup=Lo(this.anchorEl,this.popup,(()=>{this.reposition()})))}async stop(){return new Promise((e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame((()=>e()))):e()}))}reposition(){if(!this.active||!this.anchorEl)return;const e=[zo({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(Uo({apply:({rects:e})=>{const t="width"===this.sync||"both"===this.sync,n="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=n?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(jo({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Io({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(Uo({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(No({element:this.arrowEl,padding:this.arrowPadding}));const t="absolute"===this.strategy?e=>Oo.getOffsetParent(e,Vo):Oo.getOffsetParent;Fo(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:Xi(Qi({},Oo),{getOffsetParent:t})}).then((({x:e,y:t,middlewareData:n,placement:o})=>{const r="rtl"===this.localize.dir(),a={top:"bottom",right:"left",bottom:"top",left:"right"}[o.split("-")[0]];if(this.setAttribute("data-current-placement",o),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){const e=n.arrow.x,t=n.arrow.y;let o="",l="",c="",d="";if("start"===this.arrowPlacement){const n="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",l=r?n:"",d=r?"":n}else if("end"===this.arrowPlacement){const n="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";l=r?"":n,d=r?n:"",c="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(d="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",o="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(d="number"==typeof e?`${e}px`:"",o="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:o,right:l,bottom:c,left:d,[a]:"calc(var(--arrow-size-diagonal) * -1)"})}})),requestAnimationFrame((()=>this.updateHoverBridge())),this.emit("sl-reposition")}render(){return ai`
    ...
    `}};function Zo(e,t){return new Promise((n=>{e.addEventListener(t,(function o(r){r.target===e&&(e.removeEventListener(t,o),n())}))}))}function Yo(e,t,n){return new Promise((o=>{if((null==n?void 0:n.duration)===1/0)throw new Error("Promise-based animations must be finite.");const r=e.animate(t,Xi(Qi({},n),{duration:Xo()?0:n.duration}));r.addEventListener("cancel",o,{once:!0}),r.addEventListener("finish",o,{once:!0})}))}function Qo(e){return(e=e.toString().toLowerCase()).indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?1e3*parseFloat(e):parseFloat(e)}function Xo(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Jo(e){return Promise.all(e.getAnimations().map((e=>new Promise((t=>{e.cancel(),requestAnimationFrame(t)})))))}function er(e,t){const n=Qi({waitUntilFirstUpdate:!1},t);return(t,o)=>{const{update:r}=t,a=Array.isArray(e)?e:[e];t.update=function(e){a.forEach((t=>{const r=t;if(e.has(r)){const t=e.get(r),a=this[r];t!==a&&(n.waitUntilFirstUpdate&&!this.hasUpdated||this[o](t,a))}})),r.call(this,e)}}}Ko.styles=[kn,cn],Ji([$i(".popup")],Ko.prototype,"popup",2),Ji([$i(".popup__arrow")],Ko.prototype,"arrowEl",2),Ji([xi()],Ko.prototype,"anchor",2),Ji([xi({type:Boolean,reflect:!0})],Ko.prototype,"active",2),Ji([xi({reflect:!0})],Ko.prototype,"placement",2),Ji([xi({reflect:!0})],Ko.prototype,"strategy",2),Ji([xi({type:Number})],Ko.prototype,"distance",2),Ji([xi({type:Number})],Ko.prototype,"skidding",2),Ji([xi({type:Boolean})],Ko.prototype,"arrow",2),Ji([xi({attribute:"arrow-placement"})],Ko.prototype,"arrowPlacement",2),Ji([xi({attribute:"arrow-padding",type:Number})],Ko.prototype,"arrowPadding",2),Ji([xi({type:Boolean})],Ko.prototype,"flip",2),Ji([xi({attribute:"flip-fallback-placements",converter:{fromAttribute:e=>e.split(" ").map((e=>e.trim())).filter((e=>""!==e)),toAttribute:e=>e.join(" ")}})],Ko.prototype,"flipFallbackPlacements",2),Ji([xi({attribute:"flip-fallback-strategy"})],Ko.prototype,"flipFallbackStrategy",2),Ji([xi({type:Object})],Ko.prototype,"flipBoundary",2),Ji([xi({attribute:"flip-padding",type:Number})],Ko.prototype,"flipPadding",2),Ji([xi({type:Boolean})],Ko.prototype,"shift",2),Ji([xi({type:Object})],Ko.prototype,"shiftBoundary",2),Ji([xi({attribute:"shift-padding",type:Number})],Ko.prototype,"shiftPadding",2),Ji([xi({attribute:"auto-size"})],Ko.prototype,"autoSize",2),Ji([xi()],Ko.prototype,"sync",2),Ji([xi({type:Object})],Ko.prototype,"autoSizeBoundary",2),Ji([xi({attribute:"auto-size-padding",type:Number})],Ko.prototype,"autoSizePadding",2),Ji([xi({attribute:"hover-bridge",type:Boolean})],Ko.prototype,"hoverBridge",2);var tr=class extends _n{constructor(){super(),this.localize=new wn(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{"Escape"===e.key&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){const e=Qo(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.show()),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){const e=Qo(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout((()=>this.hide()),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),null==(e=this.closeWatcher)||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?(null==(e=this.closeWatcher)||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Jo(this.body),this.body.hidden=!1,this.popup.active=!0;const{keyframes:t,options:n}=an(this,"tooltip.show",{dir:this.localize.dir()});await Yo(this.popup.popup,t,n),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),null==(t=this.closeWatcher)||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Jo(this.body);const{keyframes:e,options:n}=an(this,"tooltip.hide",{dir:this.localize.dir()});await Yo(this.popup.popup,e,n),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Zo(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Zo(this,"sl-after-hide")}render(){return ai`
      <sl-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};tr.styles=[kn,ln],tr.dependencies={"sl-popup":Ko},Ji([$i("slot:not([name])")],tr.prototype,"defaultSlot",2),Ji([$i(".tooltip__body")],tr.prototype,"body",2),Ji([$i("sl-popup")],tr.prototype,"popup",2),Ji([xi()],tr.prototype,"content",2),Ji([xi()],tr.prototype,"placement",2),Ji([xi({type:Boolean,reflect:!0})],tr.prototype,"disabled",2),Ji([xi({type:Number})],tr.prototype,"distance",2),Ji([xi({type:Boolean,reflect:!0})],tr.prototype,"open",2),Ji([xi({type:Number})],tr.prototype,"skidding",2),Ji([xi()],tr.prototype,"trigger",2),Ji([xi({type:Boolean})],tr.prototype,"hoist",2),Ji([er("open",{waitUntilFirstUpdate:!0})],tr.prototype,"handleOpenChange",1),Ji([er(["content","distance","hoist","placement","skidding"])],tr.prototype,"handleOptionsChange",1),Ji([er("disabled")],tr.prototype,"handleDisabledChange",1),sn("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),sn("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});tr.define("sl-tooltip");var ir=Object.defineProperty,nr=Object.getOwnPropertyDescriptor,or=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?nr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&ir(t,n,a),a};sn("tooltip.show",null),sn("tooltip.hide",null);let rr=class extends lit_element_r{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver((e=>{for(const t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){const e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}}));const e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;e&&this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect()}render(){return ai`<sl-tooltip
			.placement=${this.placement}
	...
	`,lr([xi({reflect:!0})],dr.prototype,"icon",2),lr([xi({reflect:!0})],dr.prototype,"modifier",2),lr([xi({type:Number})],dr.prototype,"size",2),lr([xi({reflect:!0})],dr.prototype,"flip",2),lr([xi({reflect:!0})],dr.prototype,"rotate",2),dr=lr([vi("code-icon")],dr);var hr=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,ur=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?pr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&hr(t,n,a),a};let fr=class extends lit_element_r{constructor(){super(...arguments),this.icon="",this.disabled=!1}render(){return ai`
	...
	`,ur([xi()],fr.prototype,"href",2),ur([xi()],fr.prototype,"label",2),ur([xi()],fr.prototype,"icon",2),ur([xi({type:Boolean})],fr.prototype,"disabled",2),fr=ur([vi("action-item")],fr);var gr=Object.defineProperty,mr=Object.getOwnPropertyDescriptor,br=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?mr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&gr(t,n,a),a};const vr={".":"Unchanged","!":"Ignored","?":"Untracked",A:"Added",D:"Deleted",M:"Modified",R:"Renamed",C:"Copied",AA:"Conflict",AU:"Conflict",UA:"Conflict",DD:"Conflict",DU:"Conflict",UD:"Conflict",UU:"Conflict",T:"Modified",U:"Updated but Unmerged"};let yr=class extends lit_element_r{get statusName(){return this.status?vr[this.status]:""}updated(e){super.updated(e),e.has("status")&&(this.statusName?this.setAttribute("title",this.statusName):this.removeAttribute("title"))}renderIgnored(){return ai`
		...
		`],br([xi()],yr.prototype,"status",2),br([ki()],yr.prototype,"statusName",1),yr=br([vi("gl-git-status")],yr);$t`
	.sr-only,
...
`),_r=[xr,$t``],$r=[xr,$t`
	...
	`,Tr([Ai({flatten:!0})],Or.prototype,"actionNodes",2),Or=Tr([vi("action-nav")],Or);var Mr=Object.defineProperty,Lr=Object.getOwnPropertyDescriptor,Dr=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?Lr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Mr(t,n,a),a};let zr=class extends GlElement{constructor(){super(...arguments),this.branch=!1,this.expanded=!0,this.path="",this.level=0,this.size=1,this.position=1,this.checkable=!1,this.checked=!1,this.disableCheck=!1,this.showIcon=!0,this.selected=!1,this.focused=!1,this.onComponentClickBound=this.onComponentClick.bind(this)}get isHidden(){return!1===this.parentExpanded||!this.branch&&!this.expanded}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this.onComponentClickBound)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this.onComponentClickBound)}onComponentClick(e){this.selectCore({dblClick:!1,altKey:e.altKey}),this.buttonEl.focus()}updateAttrs(e,t=!1){(e.has("expanded")||t)&&this.setAttribute("aria-expanded",this.expanded.toString()),(e.has("parentExpanded")||t)&&this.setAttribute("aria-hidden",this.isHidden.toString()),(e.has("selected")||t)&&this.setAttribute("aria-selected",this.selected.toString()),(e.has("size")||t)&&this.setAttribute("aria-setsize",this.size.toString()),(e.has("position")||t)&&this.setAttribute("aria-posinset",this.position.toString()),(e.has("level")||t)&&this.setAttribute("aria-level",this.level.toString())}firstUpdated(){this.role="treeitem"}updated(e){this.updateAttrs(e)}renderBranching(){const e=this.level-1;if(e<1&&!this.branch)return ci;const t=[];if(e>0)for(let n=0;n<e;n++)t.push(ai`<span class="node node--connector"><code-icon name="blank"></code-icon></span>`);return this.branch&&t.push(ai`<code-icon class="branch" icon="${this.expanded?"chevron-down":"chevron-right"}"></code-icon>`),t}renderCheckbox(){return this.checkable?ai`<span class="checkbox"
		...
		`}selectCore(e,t=!1){this.emit("gl-tree-item-select"),this.branch&&(this.expanded=!this.expanded),this.selected=!0,t||window.requestAnimationFrame((()=>{this.emit("gl-tree-item-selected",{node:this,dblClick:e?.dblClick??!1,altKey:e?.altKey??!1,ctrlKey:e?.ctrlKey??!1,metaKey:e?.metaKey??!1})}))}select(){this.selectCore(void 0,!0)}deselect(){this.selected=!1}focus(){this.buttonEl.focus()}onButtonClick(e){e.stopPropagation(),this.selectCore({dblClick:!1,altKey:e.altKey})}onButtonDblClick(e){e.stopPropagation(),this.selectCore({dblClick:!0,altKey:e.altKey,ctrlKey:e.ctrlKey,metaKey:e.metaKey})}onCheckboxClick(e){e.stopPropagation()}onCheckboxChange(e){e.preventDefault(),e.stopPropagation(),this.checked=e.target.checked,this.emit("gl-tree-item-checked",{node:this,checked:this.checked})}};zr.styles=$r,Dr([xi({type:Boolean})],zr.prototype,"branch",2),Dr([xi({type:Boolean})],zr.prototype,"expanded",2),Dr([xi({type:String})],zr.prototype,"path",2),Dr([xi({type:String,attribute:"parent-path"})],zr.prototype,"parentPath",2),Dr([xi({type:Boolean,attribute:"parent-expanded"})],zr.prototype,"parentExpanded",2),Dr([xi({type:Number})],zr.prototype,"level",2),Dr([xi({type:Number})],zr.prototype,"size",2),Dr([xi({type:Number})],zr.prototype,"position",2),Dr([xi({type:Boolean})],zr.prototype,"checkable",2),Dr([xi({type:Boolean})],zr.prototype,"checked",2),Dr([xi({type:Boolean})],zr.prototype,"disableCheck",2),Dr([xi({type:Boolean})],zr.prototype,"showIcon",2),Dr([ki()],zr.prototype,"selected",2),Dr([ki()],zr.prototype,"focused",2),Dr([$i("#button")],zr.prototype,"buttonEl",2),zr=Dr([vi("gl-tree-item")],zr);var Ir=Object.defineProperty,Br=Object.getOwnPropertyDescriptor,jr=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?Br(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Ir(t,n,a),a};let Ur=class extends GlElement{constructor(){super(...arguments),this.treeItems=void 0}set model(e){if(this._model===e)return;let t;if(this._model=e,null!=this._model){const e=this._model.length;t=this._model.reduce(((t,n,o)=>(t.push(...Nr(n,e,o+1)),t)),[])}this.treeItems=t}get model(){return this._model}renderIcon(e){return null==e?ci:"string"==typeof e?ai`<code-icon slot="icon" icon=${e}></code-icon>`:"status"!==e.type?ci:ai`<gl-git-status slot="icon" .status=${e.name}></gl-git-status>`}renderActions(e){const t=e.actions;return null==t||0===t.length?ci:t.map((t=>ai`<action-item
				slot="actions"
				.icon=${t.icon}
				.label=${t.label}
	...
	`,qr([xi({type:Number})],Vr.prototype,"lines",2),Vr=qr([vi("skeleton-loader")],Vr);class GlTreeBase extends GlElement{renderLoading(){return ai`
...
`;var Gr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor;let Zr=class extends lit_element_r{render(){return ai`<slot class="badge" part="base"></slot>`}};Zr.styles=[Wr],Zr=((e,t,n,o)=>{for(var r,a=o>1?void 0:o?Kr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Gr(t,n,a),a})([vi("gl-badge")],Zr);var Yr=Object.defineProperty,Qr=Object.getOwnPropertyDescriptor,Xr=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?Qr(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Yr(t,n,a),a};let Jr=class extends lit_element_r{constructor(){super(...arguments),this.editor=!1}render(){return ai`<div class="group"><slot></slot></div>`}};Jr.styles=[xr,$t`
			:host {
				display: block;
				max-width: 30rem;
				margin-right: auto;
		...
		`],Xr([xi({type:Boolean})],Jr.prototype,"editor",2),Jr=Xr([vi("button-container")],Jr);var es=Object.defineProperty,ts=Object.getOwnPropertyDescriptor,is=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?ts(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&es(t,n,a),a};let ns=class extends lit_element_r{constructor(){super(...arguments),this.disabled=!1,this.full=!1}get role(){return this.href?"link":"button"}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",this.disabled.toString())}render(){return this.tooltip?ai`<gl-tooltip .content=${this.tooltip}>${this.renderControl()}</gl-tooltip>`:this.querySelectorAll('[slot="tooltip"]').length>0?ai`<gl-tooltip>
				${this.renderControl()}
			...
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};ns.shadowRootOptions={...lit_element_r.shadowRootOptions,delegatesFocus:!0},ns.styles=[xr,$t`
			:host {
		...
		`],is([$i(".control")],ns.prototype,"control",2),is([xi({reflect:!0})],ns.prototype,"appearance",2),is([xi({type:Boolean,reflect:!0})],ns.prototype,"disabled",2),is([xi({reflect:!0})],ns.prototype,"density",2),is([xi({type:Boolean,reflect:!0})],ns.prototype,"full",2),is([xi()],ns.prototype,"href",2),is([xi({reflect:!0})],ns.prototype,"role",1),is([xi()],ns.prototype,"tooltip",2),ns=is([vi("gl-button")],ns);const os=()=>({toAttribute:e=>e.getTime(),fromAttribute:(e,t)=>new Date(parseInt(e,10))}),rs=/(?<literal>\[.*?\])|(?<year>YYYY|YY)|(?<month>M{1,4})|(?<day>Do|DD?)|(?<weekday>d{2,4})|(?<hour>HH?|hh?)|(?<minute>mm?)|(?<second>ss?)|(?<fractionalSecond>SSS)|(?<dayPeriod>A|a)|(?<timeZoneName>ZZ?)/g,ss=/(?<dateStyle>full|long|medium|short)(?:\+(?<timeStyle>full|long|medium|short))?/,as=[["year",629856e5,31536e6,"yr"],["month",2628e6,2628e6,"mo"],["week",6048e5,6048e5,"wk"],["day",864e5,864e5,"d"],["hour",36e5,36e5,"h"],["minute",6e4,6e4,"m"],["second",1e3,1e3,"s"]];let ls;const cs=new Map;let ds,hs,ps;function us(e,t,n,o=!0){const r=`${n??""}:${t=t??void 0}`;let a=cs.get(r);if(null==a){const e=function(e){if(null==e)return{localeMatcher:"best fit",dateStyle:"full",timeStyle:"short"};const t=ss.exec(e);if(null!=t?.groups){const{dateStyle:e,timeStyle:n}=t.groups;return{localeMatcher:"best fit",dateStyle:e||"full",timeStyle:n||void 0}}const n={localeMatcher:"best fit"};for(const{groups:t}of e.matchAll(rs))if(null!=t)for(const[e,o]of Object.entries(t))if(null!=o)switch(e){case"year":n.year=4===o.length?"numeric":"2-digit";break;case"month":switch(o.length){case 4:n.month="long";break;case 3:n.month="short";break;case 2:n.month="2-digit";break;case 1:n.month="numeric"}break;case"day":n.day="DD"===o?"2-digit":"numeric";break;case"weekday":switch(o.length){case 4:n.weekday="long";break;case 3:n.weekday="short";break;case 2:n.weekday="narrow"}break;case"hour":n.hour=2===o.length?"2-digit":"numeric",n.hour12="hh"===o||"h"===o;break;case"minute":n.minute=2===o.length?"2-digit":"numeric";break;case"second":n.second=2===o.length?"2-digit":"numeric";break;case"fractionalSecond":n.fractionalSecondDigits=3;break;case"dayPeriod":n.dayPeriod="narrow",n.hour12=!0,n.hourCycle="h12";break;case"timeZoneName":n.timeZoneName=2===o.length?"long":"short"}return n}(t);let l;l=null==n?ds:"system"===n?void 0:[n],a=new Intl.DateTimeFormat(l,e),o&&cs.set(r,a)}if(null==t||ss.test(t))return a.format(e);function l(e){const t=`${n??""}:time:${e}`;let r=cs.get(t);if(null==r){const a={localeMatcher:"best fit",timeStyle:e};let l;l=null==n?ds:"system"===n?void 0:[n],r=new Intl.DateTimeFormat(l,a),o&&cs.set(t,r)}return r}const c=a.formatToParts(e);return t.replace(rs,((t,n,o,r,a,d,h,p,u,f,g,m,b,v,y)=>{if(null!=n)return n.substring(1,n.length-1);for(const[t,n]of Object.entries(y)){if(null==n)continue;const o=c.find((e=>e.type===t));if("Do"===n&&"day"===o?.type)return gs(Number(o.value));if("a"===n&&"dayPeriod"===o?.type){const t=l("short").formatToParts(e).find((e=>"dayPeriod"===e.type));return` ${(t??o)?.value??""}`}return o?.value??""}return""}))}const fs=["th","st","nd","rd"];function gs(e){const t=e%100;return`${e}${fs[(t-20)%10]??fs[t]??fs[0]}`}var ms=Object.defineProperty,bs=Object.getOwnPropertyDescriptor,vs=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?bs(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&ms(t,n,a),a};let ys=class extends lit_element_r{constructor(){super(...arguments),this.dateStyle="relative",this.date=new Date}render(){const e=us(this.date,this.format??"MMMM Do, YYYY h:mma");return ai`<gl-tooltip content="${e}"
			><time datetime="${this.date.toISOString()}"
				>${"relative"===this.dateStyle?function(e,t){const n=("number"==typeof e?e:e.getTime())-(new Date).getTime();for(const[e,o,r,a]of as){const l=Math.abs(n);if(l>=o||1e3===o)return t?(null==ls&&(null!=ps?ls=ps.resolvedOptions().locale:null!=hs?ls=hs.resolvedOptions().locale:(ps=new Intl.RelativeTimeFormat(ds,{localeMatcher:"best fit",numeric:"always",style:"narrow"}),ls=ps.resolvedOptions().locale)),"en"===ls||ls?.startsWith("en-")?`${Math.round(l/r)}${a}`:(null==ps&&(ps=new Intl.RelativeTimeFormat(ds,{localeMatcher:"best fit",numeric:"always",style:"narrow"})),ps.format(Math.round(n/r),e))):(null==hs&&(hs=new Intl.RelativeTimeFormat(ds,{localeMatcher:"best fit",numeric:"auto",style:"long"})),hs.format(Math.round(n/r),e))}return""}(this.date):e}</time
			></gl-tooltip
		>`}};vs([xi()],ys.prototype,"format",2),vs([xi({attribute:"date-style"})],ys.prototype,"dateStyle",2),vs([xi({converter:os(),reflect:!0})],ys.prototype,"date",2),ys=vs([vi("formatted-date")],ys);var ws=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,ks=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?xs(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&ws(t,n,a),a};let _s=class extends lit_element_r{constructor(){super(...arguments),this.name="",this.avatarUrl="https://www.gravatar.com/avatar/?s=64&d=robohash",this.showAvatar=!1,this.dateFormat="MMMM Do, YYYY h:mma",this.dateStyle="relative",this.committer=!1}renderAvatar(){return this.showAvatar&&this.avatarUrl?.length?ai`<img class="thumb" src="${this.avatarUrl}" alt="${this.name}" />`:ai`<code-icon icon="person" size="18"></code-icon>`}render(){return ai`
			<gl-tooltip>
	...
	`,za([xi({type:String})],Ia.prototype,"markdown",2),Ia=za([vi("gl-markdown")],Ia);const Ba="[A-Za-z0-9-]+",ja="~[A-Za-z]+",Ua=new RegExp(`^(${Ba})(${ja})?$`),Na=new RegExp(`\\$\\(${Ba}(?:${ja})?\\)`,"g"),Ha=new RegExp(`\\\\${Na.source}`,"g"),Fa=new RegExp(`(\\\\)?\\$\\((${Ba}(?:${ja})?)\\)`,"g");function qa(e){const t=Ua.exec(e.id);let[,n,o]=t??[void 0,"error",void 0];return n.startsWith("gitlens-")&&(n=`gl-${n.substring(8)}`),`<code-icon icon="${n}"${o?` modifier="${o}"`:""}></code-icon>`}function Va(e){return e.replace(/"/g,"&quot;")}function Wa(e){return e?e.replace(/\\([\\`*_{}[\]()#+\-.!~])/g,"$1"):e}var Ga=Object.defineProperty,Ka=Object.getOwnPropertyDescriptor,Za=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?Ka(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Ga(t,n,a),a};let Ya=class extends lit_element_r{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return ai`<div class="progress-bar"></div>`}};Ya.styles=$t`
		* {
			box-sizing: border-box;
		}
	...
	`,Za([xi({reflect:!0})],Ya.prototype,"mode",2),Za([xi({type:Boolean})],Ya.prototype,"active",2),Za([xi()],Ya.prototype,"position",2),Ya=Za([vi("progress-indicator")],Ya);var Qa=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor,Ja=(e,t,n,o)=>{for(var r,a=o>1?void 0:o?Xa(t,n):t,l=e.length-1;l>=0;l--)(r=e[l])&&(a=(o?r(t,n,a):r(a))||a);return o&&a&&Qa(t,n,a),a};let el=class extends lit_element_r{constructor(){super(...arguments),this.collapsable=!1,this.expanded=!1,this.loading=!1}renderTitle(){return this.collapsable?ai`<button
			type="button"
			class="label"
		...
		`}toggleExpanded(){this.expanded=!this.expanded,this.dispatchEvent(new CustomEvent("expanded-change",{detail:{expanded:this.expanded},bubbles:!0,composed:!0}))}};el.styles=[kr,$t`
			:host {
				display: flex;
				flex-direction: column;
